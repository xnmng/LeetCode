...
//         vector<bool> people(n, 0);
//         people[0] = true;
//         people[firstPerson] = true;
//         sort(meetings.begin(), meetings.end(), [](vector<int>& a, vector<int>& b) { return a.back() < b.back(); });
//         int index = 0;
//         while (index < meetings.size()) {
//             int time = meetings[index][2];
//             // who participated in a meeting at time t
//             vector<int> cur(n, false);
//             // if anyone who has a meeting has the secret
//             bool hasSecret = false;
//             while (index < meetings.size() && meetings[index][2] == time) {
//                 cur[meetings[index][0]] = true;
//                 cur[meetings[index][1]] = true;
//             }
//         }
//         // output ans
//         vector<int> ans;
//         ans.reserve(n);
//         for (int i = 0 ; i < n; ++i) {
//             if (people[i]) ans.emplace_back(i);
//         }
//         return ans;
//     }
// };
