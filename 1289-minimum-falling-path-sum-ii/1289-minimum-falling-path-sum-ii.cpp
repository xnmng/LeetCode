...
//         for (int i = 0; i < n; ++i) {
//             if (minIndex == -1 || grid[0][i] <= grid[0][minIndex]) {
//                 secondMinIndex = minIndex;
//                 minIndex = i;
//             } else if (secondMinIndex == -1 || grid[0][i] < grid[0][secondMinIndex]) {
//                 secondMinIndex = i;
//             }
//         }
//         // cout << minIndex << " " << secondMinIndex << "\n";
//         if (n == 1) return grid[0][minIndex];
//         int nextMinIndex;
//         int nextSecondMinIndex;
//         for (int i = 1; i < n; ++i) {
//             nextMinIndex = 0;
//             nextSecondMinIndex = 0;
//             for (int j = 0; j < n; ++j) {
//                 grid[i][j] += (j == minIndex) ? grid[i-1][secondMinIndex]
//                                                 : grid[i-1][minIndex];
//                 if (grid[i][j] <= grid[i][nextMinIndex]) {
//                     nextSecondMinIndex = nextMinIndex;
//                     nextMinIndex = i;
//                 } else if (grid[i][j] < grid[i][nextSecondMinIndex]) {
//                     nextSecondMinIndex = i;
//                 }
//             }
//             swap(minIndex, nextMinIndex);
//             swap(secondMinIndex, nextSecondMinIndex);
//         }
//         // for (auto i : grid) {
//         //     for (auto j : i) cout << j << " ";
//         //     cout << "\n";
//         // }
//         return grid[n-1][minIndex];
//     }
// };
